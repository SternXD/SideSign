...
@implementation SIDEAppID

- (instancetype)initWithName:(NSString *)name
                  identifier:(NSString *)identifier
            bundleIdentifier:(NSString *)bundleIdentifier
              expirationDate:(NSDate *)expirationDate
                    features:(NSDictionary<SIDEFeature, id> *)features
{
    self = [super init];
    if (self)
    {
...
- (nullable instancetype)initWithResponseDictionary:(NSDictionary *)responseDictionary
{
    ...
    for (SIDEFeature feature in enabledFeatures)
    {
...
{
    SIDEAppID *appID = (SIDEAppID *)object;
    if (![appID isKindOfClass:[SIDEAppID class]])
    {
        return NO;
    }
...
{
    SIDEAppID *appID = [[SIDEAppID alloc] initWithName:self.name identifier:self.identifier bundleIdentifier:self.bundleIdentifier expirationDate:self.expirationDate features:self.features];
    return appID;
}
