...
@interface SIDEProvisioningProfile : NSObject <NSCopying>
...
@property (copy, nonatomic, readonly) NSDictionary<SIDEEntitlement, id> *entitlements;
@property (copy, nonatomic, readonly) NSArray<SIDECertificate *> *certificates;
