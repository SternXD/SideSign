...
@implementation SIDEAnisetteData
...
{
    SIDEAnisetteData *anisetteData = (SIDEAnisetteData *)object;
    if (![anisetteData isKindOfClass:[SIDEAnisetteData class]])
    {
        return NO;
    }
...
{
    SIDEAnisetteData *copy = [[SIDEAnisetteData alloc] initWithMachineID:self.machineID
